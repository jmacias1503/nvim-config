...
_G.packer_plugins = {
  ...
  ["dashboard-nvim"] = {
    config = { "\27LJ\2\n�\23\0\0\6\0\f\0\0176\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0005\3\5\0005\4\4\0=\4\6\0034\4\3\0005\5\a\0>\5\1\4=\4\b\0035\4\t\0=\4\n\3=\3\v\2B\0\2\1K\0\1\0\vconfig\vfooter\1\20\0\0000                 ▄█▄                 4                ▄███▄                8               ▄█████▄               <              ▄███████▄              >             ▄ ▀▀██████▄             B            ▄██▄▄ ▀█████▄            H           ▄█████████████▄           L          ▄███████████████▄          P         ▄█████████████████▄         T        ▄███████████████████▄        X       ▄█████████▀▀▀▀████████▄       P      ▄████████▀      ▀███████▄      P     ▄█████████        ████▀▀██▄     P    ▄██████████        █████▄▄▄      X   ▄██████████▀        ▀█████████▄   P  ▄██████▀▀▀              ▀▀██████▄  B ▄███▀▀                       ▀▀███▄ 6▄▀▀                               ▀▀▄*         Yes, I use arch btw.        \vcenter\1\0\b\tdesc\17Fuzzy finder\ticon\t \ficon_hl\nTitle\vkeymap\fSPC t s\vkey_hl\vNumber\vaction\14Telescope\bkey\6f\fdesc_hl\vString\vheader\1\0\0\1\20\0\0S=================     ===============     ===============   ========  ========S\\\\ . . . . . . .\\\\   //. . . . . . .\\\\   //. . . . . . .\\\\  \\\\. . .\\\\// . . //S||. . ._____. . .|| ||. . ._____. . .|| ||. . ._____. . .|| || . . .\\/ . . .||S|| . .||   ||. . || || . .||   ||. . || || . .||   ||. . || ||. . . . . . . ||S||. . ||   || . .|| ||. . ||   || . .|| ||. . ||   || . .|| || . | . . . . .||S|| . .||   ||. _-|| ||-_ .||   ||. . || || . .||   ||. _-|| ||-_.|\\ . . . . ||S||. . ||   ||-'  || ||  `-||   || . .|| ||. . ||   ||-'  || ||  `|\\_ . .|. .||S|| . _||   ||    || ||    ||   ||_ . || || . _||   ||    || ||   |\\ `-_/| . ||S||_-' ||  .|/    || ||    \\|.  || `-_|| ||_-' ||  .|/    || ||   | \\  / |-_.||S||    ||_-'      || ||      `-_||    || ||    ||_-'      || ||   | \\  / |  `||S||    `'         || ||         `'    || ||    `'         || ||   | \\  / |   ||S||            .===' `===.         .==='.`===.         .===' /==. |  \\/  |   ||S||         .=='   \\_|-_ `===. .==='   _|_   `===. .===' _-|/   `==  \\/  |   ||S||      .=='    _-'    `-_  `='    _-'   `-_    `='  _-'   `-_  /|  \\/  |   ||S||   .=='    _-'          '-__\\._-'         '-_./__-'         `' |. /|  |   ||S||.=='    _-'                                                     `' |  /==.||S=='    _-'                        N E O V I M                         \\/   `==S\\   _-'                                                                `-_   /Q`''                                                                      ``'\1\0\1\ntheme\tdoom\nsetup\14dashboard\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
